...
public class SelectFirstByExampleMethodGenerator extends AbstractJavaMapperMethodGenerator {
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        Method method = new Method("selectFirstByExample");
        method.setDefault(true);

        method.setReturnType(recordType);
        method.addParameter(new Parameter(type, "example")); //$NON-NLS-1$
        method.addBodyLine(String.format("List<%s> items = selectByExample(example);", recordType.getShortName()));
