 ...
 * @author Jeff Butler
 */
public abstract class RenameAbstractPlugin extends PluginAdapter {
    ...
    public void initialized(IntrospectedTable introspectedTable) {
        String name = getOldName(introspectedTable);
        Matcher matcher = pattern.matcher(name);
        name = matcher.replaceAll(replaceString);

        setNewName(introspectedTable, name);
    }

    protected abstract String getOldName(IntrospectedTable introspectedTable);

    protected abstract void setNewName(IntrospectedTable introspectedTable, String name);
}
